...
export default function DashboardClient({ data }) {
    ...
    const menuItems = [
        { id: 'overview', label: 'Overview', icon: LayoutGrid, href: '/dashboard?tab=overview' },
        { id: 'businesses', label: 'My Businesses', icon: Building2, href: '/dashboard?tab=businesses' },
        { id: 'reviews', label: 'My Reviews', icon: MessageSquare, href: '/dashboard?tab=reviews' },
        { id: 'ads', label: 'Ad Manager', icon: TrendingUp, href: '/dashboard?tab=ads' },
    ];
        ...
        >
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-500">Manage your businesses and reviews.</p>
                </div>
                                    ...
                                    <Card key={business._id} className="p-6 hover:shadow-md transition-shadow">
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                            ...
                                            <div className="flex flex-col gap-2 w-full md:w-auto">
                                                ...
                                                {business.subscription_tier === 'pro' && business.subscription_end_date && new Date(business.subscription_end_date) > new Date() ? (
